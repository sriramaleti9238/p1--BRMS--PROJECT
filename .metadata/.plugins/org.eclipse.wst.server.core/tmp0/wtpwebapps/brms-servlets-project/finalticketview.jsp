<%@page import="com.viewticket.ViewTicketModal"%>
...
">
     ...
     <p style="margin:0 ;">
            Ticket Id:
            <span style="font-weight: 600;" ><%=ii.getPnr() %></span>
          </p>

        <p style="margin:2px 0;  ">
          <%=ii.getReservDateTime() %>
        </p>
      <p class="para-font">
     Thank you for choosing MSTANG BUS BOOKING for your travel arrangements. We truly appreciate your business.
        As per our conversation and agreed, we have processed your reservation under the confirmation code 
        Your Bus is now booked . Please note that you will receive the E-Ticket confirmation shortly in a separate email once the process is finalized.
		  If you need any assistance regarding changes, please contact us at 
        <b><a href="9876543210" style=" color:#0B4173;">9876543210</a></b> or email
              <b><a href = "mstangbusservices@gmail.com" style=" color:#0B4173;">mstang@triphelpdesk.com </a></b>
      ...
      <div class="scrollable-table">
        <table>
          ...
          <tr>
            <td><%=ii.getUserName() %></td>
            <td><%=ii.getEmail() %></td>
            <td><%=ii.getMblNo() %></td>
            <td><%=ii.getAge() %></td>
            <td><%=ii.getDateOfTravel() %></td>
            <td><%=ii.getPnr() %></td>
            <td><%=ii.getStatus() %></td>
            <td><%=ii.getSeatNo() %></td>
            <td><%=ii.getBirthType() %></td>
            <td><%=ii.getTicketCharges() %></td>
          </tr>
	...
	<table class='sticky-header' style='border-spacing: 0;'>
		<thead style='font-size: 12px; line-height: 16px; letter-spacing: 0.05em; text-transform: uppercase; position: sticky; top: 0; z-index: 1; background: #f5f5f5; box-shadow: 0 0 6px rgba(0, 0, 0, 0.25);'>
			<tr>
				...
				<th style='padding: 18px 24px; white-space: nowrap; border-bottom: 1px solid #c9d1dc;'>BusReg No</th>
		...
		<tbody style='font-size: 14px;'>
			<tr>
				<td style='padding: 18px 24px; white-space: nowrap; border-bottom: 1px solid #c9d1dc; border: none;'><%=ii.getReservDateTime() %></td>
				<td style='padding: 18px 24px; white-space: nowrap; border-bottom: 1px solid #c9d1dc; border: none;'><%=ii.getRegNo() %></td>
				<td style='padding: 18px 24px; white-space: nowrap; border-bottom: 1px solid #c9d1dc; border: none;'>MSTANG BUS SERVICES</td>
				<td style='padding: 18px 24px; white-space: nowrap; border-bottom: 1px solid #c9d1dc; border: none;'><%=ii.getBoardTime() %></td>
				<td style='padding: 18px 24px; white-space: nowrap; border-bottom: 1px solid #c9d1dc; border: none;'><%=ii.getSrc() %></td>
				<td style='padding: 18px 24px; white-space: nowrap; border-bottom: 1px solid #c9d1dc; border: none;'><%=ii.getArrivalTime() %></td>
				<td style='padding: 18px 24px; white-space: nowrap; border-bottom: 1px solid #c9d1dc; border: none;'><%=ii.getDest() %></td>
       ...
       <tr>
         <td  class="header-para-12x" style=" padding: .625em;font-size:18px;color:#0B4173;font-weight:400;" scope="row" style="font-size: 11px; text-align:unset;"><b>RESERVATION DATE and TIME :</b>
         <%=ii.getReservDateTime() %> 
         </td>
        </tr>
        <tr>
           <td class="header-para-12x" style=" padding: .625em;font-size:18px;color:#0B4173;font-weight:400;" scope="row" style="font-size: 11px; text-align:unset;">
       <b>Departing:</b> <%=ii.getSrc() %> @ <%=ii.getBoardTime() %>
       </td>
         </tr>
         <tr>
            <td class="header-para-12x"  style=" padding: .625em;font-size:18px;color:#0B4173;font-weight:400;" scope="row" style="font-size: 11px; text-align:unset;">
            <b> Arriving: </b><%=ii.getDest() %> @ <%=ii.getArrivalTime() %>
            </td>
         </tr>
      </table>
  ...
  <div class="Term-condtion-Div"> 
    ...
    Welcome to www.MSTANGHelpDesk.com </a></p> <br/>
    
    <p>
    The  <a href = "#" style="color: #0B4173;">www.MSTANGHelpDesk.com </a>      website (the "Site") is comprised of various web pages operated by MSTANGHelpDesk,Inc. ("THD").  <a href = "#" style="color: #0B4173;">www.MSTANGHelpDesk.com</a>   is offered to you conditioned on your acceptance without modification of the terms, conditions, and notices contained herein (the "Terms"). Your use of <a href = "#" style="color: #0B4173;"> www.MSTANGHelpDesk.com</a>    constitutes your agreement to all such Terms. Please read these terms carefully, and keep a copy of them for your reference.  
      </p>

    
    <p class="para-font" style="font-weight:600; text-align:center!important;">
      PLEASE READ THIS TERMS OF SERVICE AGREEMENT CAREFULLY. BY USING THE <a href = "#" style="color: #0B4173;">HTTPS://WWW.MSTANGHELPDESK.COM </a> WEBSITE AND RELATED WEB PAGES, YOU AGREE THAT THIS AGREEMENT IS ENFORCEABLE LIKE ANY WRITTEN CONTRACT SIGNED BY YOU. IF YOU DO NOT AGREE TO ALL OF THE TERMS OF THIS AGREEMENT, CLICK ON THE BUTTON THAT INDICATES THAT YOU DO NOT AGREE TO ACCEPT THE TERMS OF THIS AGREEMENT AND DO NOT USE THE SITE.
    </p>
    ...
    <p class="para-font">
      1.1 ABOUT TRIP HELP DESK.<a href = "#" style="color: #0B4173;"> www.MSTANGHelpDesk.com </a> is an E-Commerce BUS BOOKING  whose goal is to provide great service and discounted fares to our customers for all means of travel, logging.<br/> <br/>
...
<br/>
   ...
   ©2023 MstangHelpDesk, Inc. All rights reserved
</p>
...
<!-- section 30 --> 
      ...
      <br/>
      <br/>
      <span class="para-font" style="font-weight:600;">24 Hour Cancelation Policy:</span> From time of booking you can cancel your ticket within 24 hours for a full refund (travel inside 48 hours will not allow for a full refund and subject to fees and THD/BusReservation Policy)
      <br/>
      <br/>
      ...
      <div style="text-align: center">
        <span style="font-size: 18px;font-weight: bold"
          ><a href="" style="color: #0B4173;">MSTANGHelpDesk</a>
        </span>
        <span style="font-size: 16px; font-weight: bold; color: #0B4173;">
          powered by MSTANG</span
        >
      </div>
      <p style=" line-height:18px;text-align:center;  margin-bottom:0px; color: #0B4173;font-size: 14px;">
              ...
              <a  href="https://valalto.com/"
               ...
               MSTANG booking.</a>, All Rights Reserved.
            </p>
      </footer>
    </div>
