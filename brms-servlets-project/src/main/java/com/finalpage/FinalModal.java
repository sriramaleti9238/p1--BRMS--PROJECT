...
public class FinalModal {
	...
	public FinalModal(String regNo, int seatNo, String birthType, String status, String pnr, String reservDateTime,
	...
	public String toString() {
		return "FinalModal [RegNo=" + RegNo + ", seatNo=" + seatNo + ", birthType=" + birthType + ", status=" + status
				+ ", pnr=" + pnr + ", reservDateTime=" + reservDateTime + ", userName=" + userName + ", email=" + email
				+ ", mblNo=" + mblNo + ", age=" + age + ", src=" + src + ", dest=" + dest + ", dateOfTravel="
